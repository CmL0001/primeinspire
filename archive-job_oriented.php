		...
		<div class="row d-flex justify-content-center">
			<div class="col-lg-6 col-md-6">
				<div class="cat-header-text small text-center">
					...
					<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Blanditiis ipsam consequatur cupiditate debitis eius amet quasi quisquam aspernatur laborum commodi odit laudantium, itaque temporibus voluptatum, dolore porro culpa maxime ratione.</p>
					...
					<a href="<?php the_permalink(); ?>" class="list-group-item list-group-item-action small">
						<div class="row align-items-center">
							...
							<div class="col-lg-8 col-md-8">
								...
								<p><span class="badge bg-primary"><strong>Course Fee:</strong> <?php echo the_field('course_fee'); ?></span> <span class="badge bg-success"><strong>Duration:</strong> <?php echo the_field('course_duration'); ?></span>
								</p>
							</div>
						</div>
					</a>
